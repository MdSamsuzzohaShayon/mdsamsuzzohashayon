  ...
  return (
    <footer className="footer h-80 bg-slate-900 w-full mt-16">
      <div className="container mx-auto h-full flex flex-col items-center justify-center">
        <motion.img initial={{opacity: 0, y:20}} whileInView={{opacity: 1, y: 0}} transition={{delay: 0.2}} src={portfolio.heroImg} alt="" className='h-20 w-20 rounded-full object-fit object-cover p-2 bg-gray-800' />
